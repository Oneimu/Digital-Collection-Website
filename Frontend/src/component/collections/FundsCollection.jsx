...
export default class FundsCollection extends Component{
  ...
  findAllSchoolBuildings(currentPage) {
    ...
    axios
      .get(
        "http://localhost:5050/api/v1/school-funds/get-all-school-funds?page="+ currentPage
      )
  ...
  return (
    <div className='container_c'>
      ...
      <div className="about-header_c"> <h2 >SCHOOL BUILDING COLLECTIONS </h2> </div> 
        <div className='px_c'><p>School Building Funds by Julius Resonwald Foundation</p></div>
      </div>
      ...
      <Grid container spacing={1} style={{marginTop: "15px",marginLeft: "60px", marginRight: "10px"}}>
              {schools.map((data, index) => (
                <Grid item key={index}> <SchoolFund uid={data.uid} schoolName={data.schoolNames}></SchoolFund></Grid>
              ))}
      </Grid>
